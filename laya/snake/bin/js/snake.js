var snakeClass = /** @class */ (function () {
    function snakeClass(i) {
        this.length = 0;
        this.tiles = [];
        this.tilesDirection = [];
        this.blockSize = 10;
        this.nowDirection = new Laya.Vector3(-this.blockSize, 0, 0);
        this.snakeId = "123";
        this.sp3d = Laya.loader.getRes("../models/LayaScene_snakeScene/snakeScene" + i + ".lh").getChildAt(0);
